package com.sapiest.vaultspace.feature.currencyrates.data.impl.remote.models

import com.sapiest.vaultspace.feature.currencyrates.common.CurrencyCode
import com.sapiest.vaultspace.feature.currencyrates.data.api.models.CurrencyRateModel
...
fun CurrencyDataResponse.toCurrencyRateModel() =
    CurrencyRateModel(
        name = name,
        rate = closePrice,
